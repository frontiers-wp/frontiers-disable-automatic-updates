 ...
 * Runs instantly upon file load to intercept background cron processes.
 */
...
// Execute immediately on file load so background cron runs capture the filters
frontiers_disable_automatic_updates();
